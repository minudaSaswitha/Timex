...
namespace Timex.DataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Users] WHERE (([ID] = @Original_ID) AND ((@IsNull_User_Name = 1 AND " +
                "[User_Name] IS NULL) OR ([User_Name] = @Original_User_Name)) AND ([password] = @" +
                "Original_password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([User_Name], [password]) VALUES (@User_Name, @password);\r\nSE" +
                "LECT ID, User_Name, password FROM Users WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [User_Name] = @User_Name, [password] = @password WHERE (([ID] = @Original_ID) AND ((@IsNull_User_Name = 1 AND [User_Name] IS NULL) OR ([User_Name] = @Original_User_Name)) AND ([password] = @Original_password));
SELECT ID, User_Name, password FROM Users WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Timex.Properties.Settings.Default.TimexConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        Users.*\r\nFROM            Users\r\nWHERE User_Name=@UserID and passwor" +
                "d=@password";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserID", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "User_Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
